                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ url('admin/commission', $list->id) }}" method="POST"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/commission') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input class="form-control" type="text" name="name" value="" placeholder="Masukkan Nama Komisi">
                    </div>

                    <div class="form-group">
                        <input class="form-control" type="text" name="code" value="" placeholder="Masukkan Kode">
                    </div>
...
@foreach ($data['list'] as $list)
<!-- modal editModal -->
<div class="modal fade" id="editModal{{$list->id}}" tabindex="-1" role="dialog" aria-labelledby="editModal{{$list->id}}"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/commission', $list->id) }}" method="POST" enctype="multipart/form-data">
                    @method("PUT")
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="code" value="{{$list->code}}"
